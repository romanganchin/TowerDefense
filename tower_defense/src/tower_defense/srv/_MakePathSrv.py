...
float32 z"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self
      buff.write(_struct_6f.pack(_x.start.x, _x.start.y, _x.start.z, _x.end.x, _x.end.y, _x.end.z))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.start.x, _x.start.y, _x.start.z, _x.end.x, _x.end.y, _x.end.z,) = _struct_6f.unpack(str[start:end])
      return self
