...
"""autogenerated by genpy from tower_defense/BuildRRTSrvRequest.msg. Do not edit."""
import sys
...
class BuildRRTSrvRequest(genpy.Message):
  ...
  _type = "tower_defense/BuildRRTSrvRequest"
...
def _get_struct_I():
    ...
    return _struct_I
# This Python file uses the following encoding: utf-8
"""autogenerated by genpy from tower_defense/BuildRRTSrvResponse.msg. Do not edit."""
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
import struct
...
"""
  __slots__ = ['rrt']
  _slot_types = ['tower_defense/RRTNode[]']
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = tower_defense.msg.RRTNode()
        _v2 = val1.location
        _x = _v2
        start = end
        end += 24
...
class BuildRRTSrv(object):
  _type          = 'tower_defense/BuildRRTSrv'
  _md5sum = '9680cc06ea3c47eb5a92d56793715529'
